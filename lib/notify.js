 ...
 * Unknown tokens are kept as-is (literal) so a typo is visible instead of
 * being silently blanked out or falling back to a different message. */
...
async function send(rawTarget, payload) {
